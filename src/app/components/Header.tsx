...
export function Header() {
 ...
 <span className="absolute -right-1 -top-1 flex h-2 w-2 rounded-full bg-[#EF4444]"></span>
 </button>
 ...
 <p className="text-xs font-medium text-white uppercase">J. Smith</p>
 <p className="text-[10px] text-[#94A3B8] uppercase">Authorized Personnel</p>
 </div>
 </button>
 </DropdownMenuTrigger>
 <DropdownMenuContent align="end" className="w-56 bg-[#0F1623] border border-[#1E293B]">
 <DropdownMenuLabel className="text-xs uppercase text-[#94A3B8]">Agent ID: ID-4021</DropdownMenuLabel>
 <DropdownMenuSeparator className="bg-[#1E293B]" />
 <DropdownMenuItem className="text-sm text-white focus:bg-[#1E293B] focus:text-white">System Settings</DropdownMenuItem>
 <DropdownMenuItem className="text-sm text-white focus:bg-[#1E293B] focus:text-white">Audit Log</DropdownMenuItem>
 <DropdownMenuSeparator className="bg-[#1E293B]" />
 <DropdownMenuItem
