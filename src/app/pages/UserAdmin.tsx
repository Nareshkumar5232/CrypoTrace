...
export function UserAdmin() {
 ...
 {rolesLoading && (
 <tr>
 <td colSpan={2} className="px-4 py-6 text-center text-xs text-[#64748B] uppercase tracking-wider font-bold">
 ...
 <Loader2 className="h-4 w-4 animate-spin inline mr-2" /> LOADING PERSONNEL RECORDS...
 </td>
 </tr>
 )}
 {usersError && (
